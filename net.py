...
gwash = cv2.imread("images/img1.jpeg") #import image
...
ret,thresh1 = cv2.threshold(gwashBW,220,255,cv2.THRESH_BINARY) #the value of 15 is chosen by trial-and-error to produce the best outline of the skull
...
im2, contours, hierarchy = cv2.findContours(closing,cv2.RETR_TREE,cv2.CHAIN_APPROX_SIMPLE) #find contours with simple approximation
